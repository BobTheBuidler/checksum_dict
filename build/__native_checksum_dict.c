...
PyObject *CPyInitOnly_checksum_dict____utils(void)
{
...
__LL2: ;
    ...
    if (cpy_r_r5) {
        ...
        goto CPyL22;
CPyL6: ;
    cpy_r_r6 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__module__' */
    cpy_r_r7 = CPyObject_GetAttr(cpy_r_typ, cpy_r_r6);
    ...
    cpy_r_r10 = PyUnicode_Partition(cpy_r_r8, cpy_r_r9);
    CPy_DECREF(cpy_r_r8);
    if (unlikely(cpy_r_r10 == NULL)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", DIFFCHECK_PLACEHOLDER, CPyStatic__utils___globals);
        goto CPyL24;
...
__LL4: ;
    if (unlikely(__tmp3 == NULL)) {
        ...
        PyObject *__tmp5 = PyTuple_GET_ITEM(cpy_r_r10, 0);
        CPy_INCREF(__tmp5);
        PyObject *__tmp6;
        ...
        cpy_r_r11.f0 = __tmp6;
        PyObject *__tmp7 = PyTuple_GET_ITEM(cpy_r_r10, 1);
        CPy_INCREF(__tmp7);
        PyObject *__tmp8;
        if (likely(PyUnicode_Check(__tmp7)))
            __tmp8 = __tmp7;
        else {
            CPy_TypeError("str", __tmp7); 
            __tmp8 = NULL;
        }
        cpy_r_r11.f1 = __tmp8;
        PyObject *__tmp9 = PyTuple_GET_ITEM(cpy_r_r10, 2);
        CPy_INCREF(__tmp9);
        PyObject *__tmp10;
        if (likely(PyUnicode_Check(__tmp9)))
            __tmp10 = __tmp9;
        else {
            CPy_TypeError("str", __tmp9); 
            __tmp10 = NULL;
        }
        cpy_r_r11.f2 = __tmp10;
    }
    CPy_DECREF(cpy_r_r10);
    ...
    cpy_r_r13 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* frozenset({'Contract', 'ERC20'}) */
    cpy_r_r14 = CPy_GetName(cpy_r_typ);
    ...
    if (likely(PyUnicode_Check(cpy_r_r14)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 51, CPyStatic__utils___globals, "str", cpy_r_r14);
        goto CPyL26;
    }
    cpy_r_r16 = PySet_Contains(cpy_r_r13, cpy_r_r15);
    CPy_DECREF(cpy_r_r15);
...
CPyL14: ;
    ...
    goto CPyL17;
CPyL15: ;
    cpy_r_r20 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* frozenset({'dank_mids', 'y', 'brownie'}) */
...
CPyL12: ;
    ...
    static PyObject *CPyDunder___getitem__base___ChecksumAddressDict(PyObject *obj_self, PyObject *obj_key) {
        ...
        PyObject *arg_key;
        if (PyBytes_Check(obj_key))
            arg_key = obj_key;
        else {
            arg_key = NULL;
        }
        if (arg_key != NULL) goto __LL11;
...
fail: ;
    ...
    PyObject *CPyInitOnly_checksum_dict___base(void)
    {
...
CPyL13: ;
    ...
    if (PyBytes_Check(PyTuple_GET_ITEM(cpy_r_r22, 0)))
        __tmp13 = PyTuple_GET_ITEM(cpy_r_r22, 0);
    else {
        __tmp13 = NULL;
    }
    if (__tmp13 != NULL) goto __LL15;
...
__LL15: ;
    ...
    __tmp13 = PyTuple_GET_ITEM(cpy_r_r22, 1);
    if (__tmp13 == NULL) goto __LL14;
    __tmp13 = cpy_r_r22;
__LL14: ;
    if (unlikely(__tmp13 == NULL)) {
        ...
        PyObject *__tmp16 = PyTuple_GET_ITEM(cpy_r_r22, 0);
        CPy_INCREF(__tmp16);
        PyObject *__tmp17;
        if (PyBytes_Check(__tmp16))
            __tmp17 = __tmp16;
        else {
            __tmp17 = NULL;
        }
        if (__tmp17 != NULL) goto __LL18;
        if (PyUnicode_Check(__tmp16))
            __tmp17 = __tmp16;
        else {
            __tmp17 = NULL;
        }
        ...
        __tmp17 = __tmp16;
        if (__tmp17 != NULL) goto __LL18;
        CPy_TypeError("union[bytes, str, object]", __tmp16); 
        __tmp17 = NULL;
__LL18: ;
        cpy_r_r23.f0 = __tmp17;
        PyObject *__tmp19 = PyTuple_GET_ITEM(cpy_r_r22, 1);
        CPy_INCREF(__tmp19);
        PyObject *__tmp20;
        __tmp20 = __tmp19;
        cpy_r_r23.f1 = __tmp20;
    }
    CPy_DECREF(cpy_r_r22);
...
CPyL3: ;
    ...
    CPy_DECREF(cpy_r_r28);
    cpy_r_r29 = CPyModule_checksum_dict____utils;
    cpy_r_r30 = (PyObject *)&_Py_NoneStruct;
    cpy_r_r31 = cpy_r_r29 != cpy_r_r30;
    if (cpy_r_r31) goto CPyL14;
    cpy_r_r32 = CPyInitOnly_checksum_dict____utils;
    cpy_r_r33 = CPyExec_checksum_dict____utils;
    cpy_r_r34 = (PyObject **)&CPyModule_checksum_dict____utils__internal;
    cpy_r_r35 = PyImport_GetModuleDict();
    cpy_r_r36 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict__mypyc' */
    cpy_r_r37 = CPyDict_GetItem(cpy_r_r35, cpy_r_r36);
    if (unlikely(cpy_r_r37 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL39;
    }
    cpy_r_r38 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__file__' */
    ...
    cpy_r_r40 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '.cpython-313-x86_64-linux-gnu.so' */
    cpy_r_r41 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict._utils' */
    ...
    CPyModule_checksum_dict____utils = cpy_r_r42;
    CPy_INCREF(CPyModule_checksum_dict____utils);
    CPy_DECREF(cpy_r_r42);
CPyL14: ;
    cpy_r_r43 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('attempt_checksum',) */
    cpy_r_r44 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict._utils' */
    cpy_r_r45 = CPyStatic_base___globals;
    cpy_r_r46 = CPyImport_GetNativeAttrs(cpy_r_r44, cpy_r_r43, cpy_r_r43, cpy_r_r45);
    if (unlikely(cpy_r_r46 == NULL)) {
        ...
        goto CPyL40;
CPyL15: ;
    cpy_r_r47 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    cpy_r_r48 = CPyStatic_base___globals;
    cpy_r_r49 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'TypeVar' */
    ...
    cpy_r_r54 = CPyStatic_base___globals;
    cpy_r_r55 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    cpy_r_r59 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'Union' */
    cpy_r_r60 = CPyDict_GetItem(cpy_r_r58, cpy_r_r59);
    if (unlikely(cpy_r_r60 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL39;
    }
    cpy_r_r61 = (PyObject *)&PyDict_Type;
    cpy_r_r62 = CPyStatic_base___globals;
    cpy_r_r63 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'AnyAddressOrContract' */
    cpy_r_r64 = CPyDict_GetItem(cpy_r_r62, cpy_r_r63);
    if (unlikely(cpy_r_r64 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL41;
    }
    cpy_r_r65 = CPyStatic_base___globals;
    cpy_r_r66 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    cpy_r_r70 = PyObject_GetItem(cpy_r_r61, cpy_r_r69);
    CPy_DECREF(cpy_r_r69);
    if (unlikely(cpy_r_r70 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL41;
    }
    cpy_r_r71 = CPyStatic_base___globals;
    cpy_r_r72 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'Iterable' */
    cpy_r_r73 = CPyDict_GetItem(cpy_r_r71, cpy_r_r72);
    if (unlikely(cpy_r_r73 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL43;
    }
    cpy_r_r74 = (PyObject *)&PyTuple_Type;
    cpy_r_r75 = CPyStatic_base___globals;
    cpy_r_r76 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'AnyAddressOrContract' */
    ...
    cpy_r_r79 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    if (unlikely(cpy_r_r82 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp29 = cpy_r_r81.f0;
    PyTuple_SET_ITEM(cpy_r_r82, 0, __tmp29);
    PyObject *__tmp30 = cpy_r_r81.f1;
    PyTuple_SET_ITEM(cpy_r_r82, 1, __tmp30);
    cpy_r_r83 = PyObject_GetItem(cpy_r_r74, cpy_r_r82);
    CPy_DECREF(cpy_r_r82);
    if (unlikely(cpy_r_r83 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL44;
    }
    cpy_r_r84 = PyObject_GetItem(cpy_r_r73, cpy_r_r83);
    ...
    cpy_r_r85.f0 = cpy_r_r70;
    cpy_r_r85.f1 = cpy_r_r84;
    cpy_r_r86 = PyTuple_New(2);
    if (unlikely(cpy_r_r86 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp31 = cpy_r_r85.f0;
    PyTuple_SET_ITEM(cpy_r_r86, 0, __tmp31);
    PyObject *__tmp32 = cpy_r_r85.f1;
    PyTuple_SET_ITEM(cpy_r_r86, 1, __tmp32);
    cpy_r_r87 = PyObject_GetItem(cpy_r_r60, cpy_r_r86);
    ...
    cpy_r_r88 = CPyStatic_base___globals;
    cpy_r_r89 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '_SeedT' */
    ...
    cpy_r_r92 = (PyObject *)&PyDict_Type;
    cpy_r_r93 = CPyStatic_base___globals;
    cpy_r_r94 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ChecksumAddress' */
    cpy_r_r95 = CPyDict_GetItem(cpy_r_r93, cpy_r_r94);
    if (unlikely(cpy_r_r95 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL39;
    }
    cpy_r_r96 = CPyStatic_base___globals;
    cpy_r_r97 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    cpy_r_r98 = CPyDict_GetItem(cpy_r_r96, cpy_r_r97);
    if (unlikely(cpy_r_r98 == NULL)) {
        CPy_AddTraceback("checksum_dict/base.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_base___globals);
        goto CPyL46;
    }
    cpy_r_r99.f0 = cpy_r_r95;
    cpy_r_r99.f1 = cpy_r_r98;
    cpy_r_r100 = PyTuple_New(2);
    if (unlikely(cpy_r_r100 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp33 = cpy_r_r99.f0;
    PyTuple_SET_ITEM(cpy_r_r100, 0, __tmp33);
    PyObject *__tmp34 = cpy_r_r99.f1;
    PyTuple_SET_ITEM(cpy_r_r100, 1, __tmp34);
    cpy_r_r101 = PyObject_GetItem(cpy_r_r92, cpy_r_r100);
    ...
    cpy_r_r103 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict.base' */
    cpy_r_r104 = (PyObject *)CPyType_base___ChecksumAddressDict_template;
    ...
    CPyType_base___ChecksumAddressDict = (PyTypeObject *)cpy_r_r105;
    CPy_INCREF(CPyType_base___ChecksumAddressDict);
    cpy_r_r111 = CPyStatic_base___globals;
    cpy_r_r112 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ChecksumAddressDict' */
    ...
    cpy_r_r115 = CPy_InitSubclass(cpy_r_r105);
...
CPyL47: ;
    ...
    goto CPyL39;
        ...
        PyObject *CPyInitOnly_checksum_dict___default(void)
        {
...
CPyL15: ;
    ...
    if (PyBytes_Check(PyTuple_GET_ITEM(cpy_r_r29, 0)))
        __tmp35 = PyTuple_GET_ITEM(cpy_r_r29, 0);
    else {
        __tmp35 = NULL;
    }
    if (__tmp35 != NULL) goto __LL37;
    ...
    __tmp35 = NULL;
__LL37: ;
    if (__tmp35 == NULL) goto __LL36;
    __tmp35 = PyTuple_GET_ITEM(cpy_r_r29, 1);
    if (__tmp35 == NULL) goto __LL36;
    __tmp35 = cpy_r_r29;
__LL36: ;
    if (unlikely(__tmp35 == NULL)) {
        CPy_TypeError("tuple[union[bytes, str, object], object]", cpy_r_r29); cpy_r_r30 = (tuple_T2OO) { NULL, NULL };
    } else {
        PyObject *__tmp38 = PyTuple_GET_ITEM(cpy_r_r29, 0);
        CPy_INCREF(__tmp38);
        PyObject *__tmp39;
        if (PyBytes_Check(__tmp38))
            __tmp39 = __tmp38;
        else {
            __tmp39 = NULL;
        }
        if (__tmp39 != NULL) goto __LL40;
        if (PyUnicode_Check(__tmp38))
            __tmp39 = __tmp38;
        else {
            __tmp39 = NULL;
        }
        ...
        __tmp39 = __tmp38;
        if (__tmp39 != NULL) goto __LL40;
        CPy_TypeError("union[bytes, str, object]", __tmp38); 
        __tmp39 = NULL;
__LL40: ;
        cpy_r_r30.f0 = __tmp39;
        PyObject *__tmp41 = PyTuple_GET_ITEM(cpy_r_r29, 1);
        CPy_INCREF(__tmp41);
        PyObject *__tmp42;
        __tmp42 = __tmp41;
        cpy_r_r30.f1 = __tmp42;
    }
...
char CPyDef_default___DefaultChecksumDict_____init___3__DefaultChecksumDict_glue(PyObject *cpy_r_self, PyObject *cpy_r_default, PyObject *cpy_r_seed) {
    ...
    if (cpy_r_r2 == NULL) goto CPyL11;
    cpy_r_r3 = (CPyPtr)((CPyPtr)cpy_r_r2 + offsetof(PyListObject, ob_item));
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule_mypy_extensions);
    CPy_DECREF(cpy_r_r24);
    cpy_r_r25 = CPyModule_checksum_dict___base;
    cpy_r_r26 = (PyObject *)&_Py_NoneStruct;
    cpy_r_r27 = cpy_r_r25 != cpy_r_r26;
    if (cpy_r_r27) goto CPyL13;
    cpy_r_r28 = CPyInitOnly_checksum_dict___base;
    cpy_r_r29 = CPyExec_checksum_dict___base;
    cpy_r_r30 = (PyObject **)&CPyModule_checksum_dict___base__internal;
    cpy_r_r31 = PyImport_GetModuleDict();
    cpy_r_r32 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict__mypyc' */
    cpy_r_r33 = CPyDict_GetItem(cpy_r_r31, cpy_r_r32);
    if (unlikely(cpy_r_r33 == NULL)) {
        CPy_AddTraceback("checksum_dict/default.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_default___globals);
        goto CPyL27;
    }
    cpy_r_r34 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__file__' */
    ...
    cpy_r_r36 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '.cpython-313-x86_64-linux-gnu.so' */
    cpy_r_r37 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict.base' */
    ...
    CPyModule_checksum_dict___base = cpy_r_r38;
    CPy_INCREF(CPyModule_checksum_dict___base);
    CPy_DECREF(cpy_r_r38);
CPyL13: ;
    cpy_r_r39 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('ChecksumAddressDict', 'T', '_SeedT') */
    cpy_r_r40 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict.base' */
    cpy_r_r41 = CPyStatic_default___globals;
    cpy_r_r42 = CPyImport_GetNativeAttrs(cpy_r_r40, cpy_r_r39, cpy_r_r39, cpy_r_r41);
    if (unlikely(cpy_r_r42 == NULL)) {
        CPy_AddTraceback("checksum_dict/default.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_default___globals);
        goto CPyL27;
    } else
        goto CPyL28;
CPyL14: ;
    cpy_r_r43 = CPyStatic_default___globals;
    cpy_r_r44 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'DefaultDict' */
    cpy_r_r45 = CPyDict_GetItem(cpy_r_r43, cpy_r_r44);
    if (unlikely(cpy_r_r45 == NULL)) {
        CPy_AddTraceback("checksum_dict/default.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_default___globals);
        goto CPyL27;
    }
    cpy_r_r46 = CPyStatic_default___globals;
    cpy_r_r47 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'ChecksumAddress' */
    ...
    cpy_r_r50 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    ...
    if (unlikely(cpy_r_r53 == NULL))
        CPyError_OutOfMemory();
    PyObject *__tmp45 = cpy_r_r52.f0;
    PyTuple_SET_ITEM(cpy_r_r53, 0, __tmp45);
    PyObject *__tmp46 = cpy_r_r52.f1;
    PyTuple_SET_ITEM(cpy_r_r53, 1, __tmp46);
    ...
    cpy_r_r55 = (PyObject *)CPyType_base___ChecksumAddressDict;
    cpy_r_r56 = CPyStatic_default___globals;
    cpy_r_r57 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'T' */
    cpy_r_r58 = CPyDict_GetItem(cpy_r_r56, cpy_r_r57);
    if (unlikely(cpy_r_r58 == NULL)) {
        CPy_AddTraceback("checksum_dict/default.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_default___globals);
        goto CPyL31;
    }
    cpy_r_r59 = PyObject_GetItem(cpy_r_r55, cpy_r_r58);
    CPy_DECREF(cpy_r_r58);
    if (unlikely(cpy_r_r59 == NULL)) {
        CPy_AddTraceback("checksum_dict/default.py", "<module>", DIFFCHECK_PLACEHOLDER, CPyStatic_default___globals);
        goto CPyL31;
    }
    cpy_r_r60 = PyTuple_Pack(2, cpy_r_r54, cpy_r_r59);
    ...
    cpy_r_r61 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'checksum_dict.default' */
    cpy_r_r62 = (PyObject *)CPyType_default___DefaultChecksumDict_template;
    ...
    cpy_r_r64 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__mypyc_attrs__' */
    cpy_r_r65 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* '__dict__' */
    ...
    CPyType_default___DefaultChecksumDict = (PyTypeObject *)cpy_r_r63;
    CPy_INCREF(CPyType_default___DefaultChecksumDict);
    cpy_r_r69 = CPyStatic_default___globals;
    cpy_r_r70 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'DefaultChecksumDict' */
    ...
    cpy_r_r73 = CPy_InitSubclass(cpy_r_r63);
...
CPyL32: ;
    ...
    "\a\034\' is not a valid ETH address\n__module__\001.\bContract\005ERC20\tdank_mids\001y",
    "\b\abrownie\bbuiltins\rTYPE_CHECKING\003Any\005Final\005Union\006typing\tcchecksum",
    ...
    "\003\024AnyAddressOrContract\025checksum_dict._typing\024checksum_dict__mypyc",
    "\003\b__file__ .cpython-313-x86_64-linux-gnu.so\024checksum_dict._utils",
    "\006\020attempt_checksum\001T\006_SeedT\022checksum_dict.base\017__mypyc_attrs__\b__dict__",
    "\005\023ChecksumAddressDict\vdefaultdict\017default_factory\vcollections\bCallable",
    "\003\vDefaultDict\025checksum_dict.default\023DefaultChecksumDict",
    "",
};
    ...
    13, 4, 17, 18, 19, 20, 3, 22, 22, 22, 1, 69, 1, 25, 1, 28, 4, 42,
    43, 20, 44, 1, 45, 1, 36, 1, 48, 1, 54, 1, 61, 3, 64, 65, 42, 3, 60,
    55, 56
};
            const int CPyLit_FrozenSet[] = {2, 2, 11, 12, 3, 13, 14, 15};

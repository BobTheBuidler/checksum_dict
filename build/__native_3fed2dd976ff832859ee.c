...
CPyL6: ;
    ...
    if (likely(PyUnicode_Check(cpy_r_r14)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "attempt_checksum", 31, CPyStatic__utils___globals, "str", cpy_r_r14);
        goto CPyL27;
    }
...
CPyL11: ;
    ...
    if (unlikely(cpy_r_r17 == 2)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "attempt_checksum", 32, CPyStatic__utils___globals);
        goto CPyL30;
    }
    if (cpy_r_r17) {
        goto CPyL31;
...
CPyL16: ;
    ...
    if (likely(PyUnicode_Check(cpy_r_r25)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "attempt_checksum", 35, CPyStatic__utils___globals, "str", cpy_r_r25);
        goto CPyL27;
    }
...
CPyL22: ;
    ...
    if (likely(PyUnicode_Check(cpy_r_r33)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "attempt_checksum", 37, CPyStatic__utils___globals, "str", cpy_r_r33);
        goto CPyL27;
    }
...
CPyL4: ;
    ...
    if (unlikely(cpy_r_r9 == NULL)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "checksum_or_raise", 43, CPyStatic__utils___globals);
        goto CPyL13;
    }
...
char CPyDef__utils____type_has_checksum_addr(PyObject *cpy_r_typ) {
    ...
    if (unlikely(!cpy_r_r1)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 48, CPyStatic__utils___globals);
        goto CPyL25;
    }
    CPy_Unreachable();
CPyL3: ;
...
CPyL6: ;
    ...
    if (likely(PyUnicode_Check(cpy_r_r8)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 50, CPyStatic__utils___globals, "str", cpy_r_r8);
        goto CPyL25;
    }
    ...
    goto CPyL18;
CPyL11: ;
    cpy_r_r14 = CPyStatics[83]; /* frozenset({'brownie', 'y', 'dank_mids'}) */
    ...
    if (likely(PyUnicode_Check(cpy_r_r16)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 50, CPyStatic__utils___globals, "str", cpy_r_r16);
        goto CPyL25;
    }
    ...
    if (likely(PyUnicode_Check(cpy_r_r20)))
        ...
        CPy_TypeErrorTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 50, CPyStatic__utils___globals, "str", cpy_r_r20);
        goto CPyL25;
    }
...
CPyL18: ;
    ...
    if (unlikely(cpy_r_r26 == 2)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 53, CPyStatic__utils___globals);
        goto CPyL27;
    }
...
CPyL23: ;
    ...
    if (unlikely(cpy_r_r32 == 2)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 54, CPyStatic__utils___globals);
        goto CPyL25;
    }
    return cpy_r_r32;
CPyL25: ;
...
PyObject *CPyPy__utils____type_has_checksum_addr(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("checksum_dict/_utils.py", "_type_has_checksum_addr", 47, CPyStatic__utils___globals);
    return NULL;
}
...
CPyL3: ;
    ...
    if (unlikely(cpy_r_r34 == NULL)) {
        CPy_AddTraceback("checksum_dict/_utils.py", "<module>", 23, CPyStatic__utils___globals);
        goto CPyL14;
    }
...
const char * const CPyLit_Str[] = {
    ...
    "\006\034\' is not a valid ETH address\005ERC20\bContract\b__name__\abrownie\001y",

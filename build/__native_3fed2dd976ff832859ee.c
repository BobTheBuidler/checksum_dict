...
char CPyDef_base_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* ('Dict', 'Optional', 'Tuple', 'TypeVar', 'Union',
                                  'overload') */
    cpy_r_r6 = CPyStatics[DIFFCHECK_PLACEHOLDER]; /* 'typing' */
...
const char * const CPyLit_Str[] = {
    ...
    "\005\aTypeVar\boverload\017collections.abc\nmypyc_attr\017mypy_extensions",
...
const int CPyLit_Tuple[] = {
    14, 5, 17, 18, 19, 20, 21, 3, 23, 23, 23, 1, 69, 1, 26, 1, 28, 6,
    18, 44, 45, 46, 21, 47, 1, 31, 1, 49, 1, 39, 1, 51, 1, 53, 1, 61, 3,
    64, 65, 44, 3, 60, 55, 56
};
